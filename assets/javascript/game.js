...
$(document).ready(function () {
    ...
    var characters = {
        "Cammy": {
            ...
            health: 140,
            attack: 10,
            imageUrl: "assets/images/cammy-fighter.png",
            enemyAttackBack: 15
        },
        "Chunli": {
            name: "Chunli",
            health: 150,
            attack: 9,
            imageUrl: "assets/images/chunli-fighter.png",
            enemyAttackBack: 12
        },
        "Guile": {
            name: "Guile",
            health: 160,
            attack: 7,
            imageUrl: "assets/images/guile-fighter.png",
            enemyAttackBack: 16
        },
        "Ryu": {
            name: "Ryu",
            health: 180,
            attack: 10,
            imageUrl: "assets/images/ryu-fighter.png",
            enemyAttackBack: 5
        }
    ...
    var renderCharacter = function (character, renderArea) {
        ...
        var charHealth = $("<div class='character-health'>").text("Health Level: " + character.health);
    ...
    $("#avaliable-to-attack-section").on("click", ".character", function() {
